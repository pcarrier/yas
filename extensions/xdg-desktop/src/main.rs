//! `@xdg-desktop` — native YAS application supervision.
//!
...
use yas_ext_xdg_desktop::desktop_entry::{self, DesktopEntry};
use yas_ext_xdg_desktop::icon;
use yas_ext_xdg_desktop::supervisor::{App, Phase, next_deadline_ns};
...
/// each other's intent.
const KV_PREFIX: &str = "ext/xdg-desktop/app/";
...
const CHANNEL_NAME: &str = "yas.xdg-desktop.v1";
