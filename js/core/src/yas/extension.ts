...
export function encodeExtensionDeploy(value: YasExtensionDeploy): Uint8Array {
  ...
  return writer
    ...
    .bytes(encodeKnownExtensions(value.extensions, "Extension DEPLOY"))
    .finish();
}
...
export function decodeExtensionDeploy(bytes: Uint8Array): YasExtensionDeploy {
  ...
  const value = {
    ...
    extensions: decodeExtensions(cursor, new Set(), "Extension DEPLOY"),
  };
...
function validateDeploy(value: YasExtensionDeploy): void {
  ...
  encodeKnownExtensions(value.extensions, "Extension DEPLOY");
}
