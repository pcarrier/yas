...
/**
 * Per-surface signature of everything reactive surface consumers read.
 *
 ...
 * a consumer needs has to appear in it — a field left out here silently stays
 * stale. `parentId` is included because child-to-toplevel promotion controls
 * whether the layout engine places the window at all.
 */
