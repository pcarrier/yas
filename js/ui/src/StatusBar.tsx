...
export function StatusBar(props: {
  ...
  onMount(() => {
    ...
    const onPressStart = (e: PointerEvent | TouchEvent) => {
    ...
    // iPadOS can deliver a native touch sequence without the compatibility
    // pointer event, especially when a touched control owns touch activation.
