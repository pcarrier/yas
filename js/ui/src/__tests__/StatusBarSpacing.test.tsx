...
describe("status-bar icon spacing", () => {
  ...
  it("dismisses the connection popover on an outside iPad touchstart", () => {
    mount(14, true);
    document.querySelector<HTMLButtonElement>('[role="status"]')!.click();
    expect(
      document.querySelector("[data-yas-connection-status-popover]"),
    ).not.toBeNull();
