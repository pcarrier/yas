...
function AppCrash(props: { err: unknown }) {
  ...
  return (
    ...
    >
      <b style={{ color: "#f66" }}>yas hit an unexpected error</b>
...
function ConnectedApp(props: {
  ...
  const edgeTransport = new YasEdgeWebSocketTransport(
    edgeWsUrl(),
    props.passphrase,
  );
  ...
  function connect(pass: string) {
    ...
    ws.onmessage = (ev) => {
      ...
      if (msg === "ok") {
        ...
        setAuthError(detail || "Home server unavailable");
      }
    };
