...
const serverRoot = mkdtempSync(join(tmpdir(), "yas-fd-channel-"));
...
const server = spawn(
  ...
  ],
  {
    env: {
      ...
      YAS_EXT: "0",
      YAS_CHANNEL: "0",
      XDG_STATE_HOME: join(serverRoot, "state"),
      XDG_CACHE_HOME: join(serverRoot, "cache"),
    },
