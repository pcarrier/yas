...
// This vendored build intentionally exposes only the parser/stateless backend
// subset. Upstream items for disabled encoder/device features remain in the
// source tree, and newer compilers diagnose historical elided-lifetime
// spellings. Keep application builds quiet without rewriting those APIs.
