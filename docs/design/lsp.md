...
Windows file URIs use `file:///C:/...` or `file://server/share/...`. Decoding
restores the canonical `\\?\` path namespace used by document and diagnostic
keys, including paths for files that have not been created yet.
