...
Routine snapshots update this session in place. Unchanged metadata, playback
state, and action handlers are retained so iPad Now Playing does not blink
between updates. Retained handlers resolve the current player and track when
invoked.
