...
### 1 · Content kind — assignment-driven

Pane content is determined by its assignment. Layouts persist the structured
container tree; they have no language or preset sigils. Editor and diff views
open through explicit actions and persist their stable tab references in the
workspace assignments. There is no parallel pane-role system.
